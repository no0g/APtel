                      ...
                      <table class="table card-table table-hover table-responsive table-responsive-large" style="width:100%">
                        <thead>
                          <tr>
                            ...
                            <th class="d-none d-md-table-cell">TP Number</th>
                        ...
                        <tbody >
                              <?php
                                    ...
                                    $total_pages_sql = $mysqli->query("SELECT COUNT(*) FROM student");
                                    $total_rows = mysqli_fetch_array($total_pages_sql)[0];
                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                    //actual data
                                    $check = $mysqli->prepare("select student.id, student.firstName, student.lastName, student.tpnumber, student.email, student.contact from student LIMIT $offset, $no_of_records_per_page");
                          ...
                          <tr>
                            ...
                            <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($tpnumber) ; ?></td>
                            <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($email) ; ?></td>
                            <td class="d-none d-md-table-cell"><?php echo htmlspecialchars($contact) ; ?>  </td>
                            <td class="text-right">
