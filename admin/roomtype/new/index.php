                ...
                <ul class="nav navbar-nav">
                  ...
                  <?php include '../../../assets/template/useradmin.php'; ?>
									...
									<div class="card card-default">
										...
										<div class="card-body">
											<form method="POST" action="../../../controller/admin/roomtype/new.php" enctype="multipart/form-data" id="edit">
												<div class="row">
													<div class="col-sm-6">
                          ...
                          <div class="col-sm-12">
														<div class="form-group">
															...
															<textarea id="mytextarea" name="Description" class="form-control" placeholder="Description"></textarea>
														</div>
													</div>
												</div>             
