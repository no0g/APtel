            ...
            <div class="col-xl-5 col-lg-6 col-md-10">
              <div class="card">
                ...
                <div class="card-body p-5">
                  ...
                  <form role="form" method=POST action="../../controller/admin/register.php">
                    <div class="row">
                      ...
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" placeholder="Staff Email" required>
                      </div>
                      <div class="form-group col-md-12 ">
                        <input type="text" class="form-control input-lg" name="staffnumber" placeholder="Staff ID" required>
                      </div>
                      <div class="form-group col-md-12 ">
